...
.img_box li .pic { display:block; width:100%px; float:left; margin-left: 40px; margin-top: 100px; }
...
.thum_lst li { float: left; width: 300px; margin-left: 50px; overflow: hidden; height: 300px; margin-top: 60px; position: relative;
    left: 7%;}
.thum_lst li a{ display: block; width: 300px; height: 300px; overflow: hidden; margin: 10px auto;  background-color: #d9daff;}
...
<div class="page" id="page1">
        ...
        <figure id="img">
        <h2 class="page_tit"><a href="">로고</a></h2>
